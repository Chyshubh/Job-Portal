      ...
      <div className="container px-4 min-h[65vh] 2xl:px-20 mx-auto my-10">
            ...
            isEdit ?
              <>
                <label htmlFor="resumeUpload" className="flex items-center">
                  ...
                  <input id='resumeUpload' onChange={e => setResume(e.target.files[0])} accept='application/pdf' type="file" className="" hidden />
        ...
        <thead >
          <tr>
            ...
            <th className='py-3 px-4 border-b text-left max-sm:hidden'>Job Title</th>
            <th className='py-3 px-4 border-b text-left max-sm:hidden'>Location</th>
            <th className='py-3 px-4 border-b text-left max-sm:hidden'>date</th>
            <th className='py-3 px-4 border-b text-left max-sm:hidden'>Status</th>
          </tr>
        </thead>
        <tbody>
